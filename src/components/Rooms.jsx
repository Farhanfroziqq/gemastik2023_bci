...
const Rooms = () => {
  return (
    <div className='max-w-[1400px] h-[500px] bg-slate-200 mx-auto my-40 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid lg:grid-cols-3 gap-4 '>
        <div className="lg:top-20 relative lg:col-span-1 col-span-2">
            <h3 className='text-2xl font-bold'>Get Your Ideal Body</h3>
            <p className='pt-4'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eius, veniam possimus qui in quisquam atque.</p>
        </div>
