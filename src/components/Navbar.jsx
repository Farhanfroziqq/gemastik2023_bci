...
const Navbar = () => {
	...
	return (
		<div className='absolute w-full flex justify-between p-6 items-center'>
			<h1 className='text-white font-bold text-xl z-10'>Nutrition Assistant</h1>
			<HiMenuAlt3
				onClick={handleNav}
			...
			<div
				className={
					nav
						? "ease-in duration-500 fixed text-gray-300 left-0 top-0 w-full lg:w-2/4 h-screen bg-black/90 px-4 py-7 flex-col z-20"
						: "absolute top-0 left-[-100%] h-screen ease-in duration-500 z-0"
				}
			>
